...
class LocalStorageService {
  ...
  // — simpan mahasiswa aktif di list (MAHASISWA AKTIF) ————————————————————————————
  /// Tambah user ke list (tidak menghapus yang lama)
  ...
  /// Ambil semua mahasiswa yang sudah disimpan (MAHASISWA AKTIF)
  ...
  /// delete mahasiswa tertentu dari list (MAHASISWA AKTIF)
